...
#define ETHANE_HEATER_1_PIN   43
#define ETHANE_HEATER_2_PIN   45
#define NITROUS_HEATER_1_PIN  49
#define NITROUS_HEATER_2_PIN  41
...
#define REROUTE_TC_REDLINE 550

#define ETHANE_OVERPRESSURE_PRIORITY        5
#define NITROUS_OVERPRESSURE_PRIORITY       4
#define ETHANE_MBV_CLOSE_FAILURE_PRIORITY   6
#define NITROUS_MBV_CLOSE_FAILURE_PRIORITY  7
#define COMBUSTION_PROPOGATION_PRIORITY     8
#define INLINE_THERMAL_DECOMP_PRIORITY      9
#define LOST_LOAD_CELL_PRIORITY             1
#define ETHANE_UNDERWEIGHT_PRIORITY         10
#define NITROUS_UNDERWEIGHT_PRIORITY        1
#define ETHANE_OVERWEIGHT_PRIORITY          1
#define NITROUS_OVERWEIGHT_PRIORITY         3
